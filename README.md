...
- The `validation` folder is currently empty. Add images to better validate training performance.
- You can extend this model with more gesture classes or deeper layers for more complex tasks.

## 📬 Contact

For suggestions or collaborations, feel free to fork this repository or open an issue.
